...
###**📁 Project Files**  
**1. Ecommerce_Sales_Analysis.pbix**  
          - Power BI project file (open in Power BI Desktop)  
**2. Orders.csv**  
          - Order-level data: Order ID, Date, Customer Name, State, City  
**3. Details.csv**  
          - Transaction-level data: Amount, Profit, Quantity, Category, Sub-Category, Payment Mode  
**4. Dashboard.png**  
          - Static screenshot of the final dashboard  

###**📈Key Metrics**  
*Total Quantity Sold: 487  
*Average Order Value (AOV): 18K  
*Total Profit: 7K  
*Total Sales Amount: 77K  
...
**3. DAX —** calculated measures (Profit, AOV, etc.)    


###**💡 Key Insights**   
COD is the most preferred payment mode (39%), followed by UPI (24%)  
Electronics contributes the highest share of quantity sold (42%)  
Printers and Tables are the top profit-generating sub-categories  
Sales show seasonal dips mid-year (June–October) with a strong recovery in November  
